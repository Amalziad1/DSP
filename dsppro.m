...
training_files_female = dir('C:\Users\Administrator\??? ??????\project\train-female\*.wav');
training_files_male = dir('C:\Users\Administrator\??? ??????\project\train-male\*.wav');
training_files_hi = dir('C:\Users\Administrator\??? ??????\project\train\hi\*.wav');
training_files_bye = dir('C:\Users\Administrator\??? ??????\project\train\bye\*.wav');
testing_files_hibye = dir('C:\Users\Administrator\??? ??????\project\test-HiBye\*.wav');
testing_files_femalemale = dir('C:\Users\Administrator\??? ??????\project\test-MaleFemale\*.wav');
